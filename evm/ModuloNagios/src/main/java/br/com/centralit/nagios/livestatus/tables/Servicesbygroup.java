 ...
 */
public class Servicesbygroup extends LS_TablesBase {
	...
	*/
	@NotNull
	@JsonProperty
	public String servicegroup_action_url = null;
	/**
	*	An alias of the service group
	*/
	@NotNull
	@JsonProperty
	public String servicegroup_alias = null;
	/**
	*	A list of all members of the service group as host/service pairs
	*/
	@NotNull
	@JsonProperty
	public String servicegroup_members = null;
	/**
	*	A list of all members of the service group with state and has_been_checked
	*/
	@NotNull
	@JsonProperty
	public String servicegroup_members_with_state = null;
	/**
	*	The name of the service group
	*/
	@NotNull
	@JsonProperty
	public String servicegroup_name = null;
	/**
	*	Optional additional notes about the service group
	*/
	@NotNull
	@JsonProperty
	public String servicegroup_notes = null;
	/**
	*	An optional URL to further notes on the service group
	*/
	@NotNull
	@JsonProperty
	public String servicegroup_notes_url = null;
	/**
	*	The total number of services in the group
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services = 0;
	/**
	*	The number of services in the group that are CRIT
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_crit = 0;
	/**
	*	The number of services in the group that are CRIT
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_hard_crit = 0;
	/**
	*	The number of services in the group that are OK
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_hard_ok = 0;
	/**
	*	The number of services in the group that are UNKNOWN
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_hard_unknown = 0;
	/**
	*	The number of services in the group that are WARN
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_hard_warn = 0;
	/**
	*	The number of services in the group that are OK
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_ok = 0;
	/**
	*	The number of services in the group that are PENDING
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_pending = 0;
	/**
	*	The number of services in the group that are UNKNOWN
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_unknown = 0;
	/**
	*	The number of services in the group that are WARN
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_num_services_warn = 0;
	/**
	*	The worst soft state of all of the groups services (OK <= WARN <= UNKNOWN <= CRIT)
	*/
	@NotNull
	@JsonProperty
	public int servicegroup_worst_service_state = 0;
	/**
	...
	*/
	...
	public String toString(){
		...
		"Servicegroup_action_url = " + servicegroup_action_url + "\n" +
		"Servicegroup_alias = " + servicegroup_alias + "\n" +
		"Servicegroup_members = " + servicegroup_members + "\n" +
		"Servicegroup_members_with_state = " + servicegroup_members_with_state + "\n" +
		"Servicegroup_name = " + servicegroup_name + "\n" +
		"Servicegroup_notes = " + servicegroup_notes + "\n" +
		"Servicegroup_notes_url = " + servicegroup_notes_url + "\n" +
		"Servicegroup_num_services = " + servicegroup_num_services + "\n" +
		"Servicegroup_num_services_crit = " + servicegroup_num_services_crit + "\n" +
		"Servicegroup_num_services_hard_crit = " + servicegroup_num_services_hard_crit + "\n" +
		"Servicegroup_num_services_hard_ok = " + servicegroup_num_services_hard_ok + "\n" +
		"Servicegroup_num_services_hard_unknown = " + servicegroup_num_services_hard_unknown + "\n" +
		"Servicegroup_num_services_hard_warn = " + servicegroup_num_services_hard_warn + "\n" +
		"Servicegroup_num_services_ok = " + servicegroup_num_services_ok + "\n" +
		"Servicegroup_num_services_pending = " + servicegroup_num_services_pending + "\n" +
		"Servicegroup_num_services_unknown = " + servicegroup_num_services_unknown + "\n" +
		"Servicegroup_num_services_warn = " + servicegroup_num_services_warn + "\n" +
		"Servicegroup_worst_service_state = " + servicegroup_worst_service_state + "\n" +
		"Staleness = " + staleness + "\n" +
		"State = " + state + "\n" +
